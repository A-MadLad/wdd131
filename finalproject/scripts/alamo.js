...
const fun = [
  {
    ...
    imageUrl: "./images/pl.webp",
    description:
      "McGinn's PistachioLand produces many award winning wines, pistachio candies, flavored pistachios and pistashico ice cream.",
